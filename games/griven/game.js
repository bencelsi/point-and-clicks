...
rooms: {
    ...
    'lobby' : { //zlobby
        ...
        'H4': { left: 'H3', right: 'H1', boxes: [ { xy: [.57, .7, .4, .63],
            ...
            fn: () => { if (s.cafeUnlocked) { playSound('doorOpen') } else { playSound('doorLocked') }}}]},
    ...
    'pool': { //zpool
        ...
        'B2': { left: 'B1', right: 'B3' },
        'B3': { left: 'B2', right: 'B4', boxes: [ { xy: [.2, .8, .4, 1], to: 'clockroom/A3', 
    ...
    'hall': { //zhall
        ...
        'A2': { left: () => { hallTurnLeft(); return s.hallPosition == 2 ? 'A7' : (s.hallPosition == 6 ? 'A9' : 'A5')},
            right: () => { hallTurnRight(); return s.hallPosition == 2 ? 'A6' : (s.hallPosition == 6 ? 'A8' : 'A5')},
            forward: () => { hallMoveForward(); return 'A3'}},
        'A3': { left: () => { hallTurnLeft(); return s.hallPosition == 2 ? 'A6' : (s.hallPosition == 6 ? 'A8' : 'A5')},
            right: () => { hallTurnRight(); return s.hallPosition == 2 ? 'A7' : (s.hallPosition == 6 ? 'A9' : 'A5')},
            forward: () => { hallMoveForward(); return 'A4' }},
        'A4': { left: () => { hallTurnLeft(); return 'A5' },
            right: () => { hallTurnRight(); return 'A5' }},
        'A5': { left: () => { hallTurnLeft(); return hallTurnLogic() },
        ...
        'A5a': { left: () => { hallTurnLeft(); return hallTurnLogic() },
            right: () => { hallTurnRight(); return hallTurnLogic() },
            forward: 'room/A2', boxes: [
                { pic: 'roomFloor2', offset: [.44,.94]},
                { pic: 'room9', offset: [.46,.94]}]},
        'A6': { left: () => { hallTurnLeft(); return 'A2' },
            right: () => { hallTurnRight(); return 'A3' },
            forward: 'stairs/A4' },
        'A7': { left: () => { hallTurnLeft(); return 'A3' },
            right: () => { hallTurnRight(); return 'A2' },
            forward: 'B2'},
        'A8': { left: () => { hallTurnLeft(); return 'A2'},
            right: () => { hallTurnRight(); return 'A3'},
            forward: 'B4'},
        'A9': { left: () => { hallTurnLeft(); return 'A3' },
            right: () => { hallTurnRight(); return 'A2' }},
        'A10': {
            boxes: [
...
function saladButton(n) { playSound('button')
