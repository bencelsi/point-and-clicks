...
const gameData = {
    ...
    'room': {
		...
		// Include room in filename?
		// K: Kitchen L: Ladder/Loft B: Bathroom H: Hallway Z: Bedroom O: outside
		// K1a, B2b?

        'A1': { left: 'A4', right: 'A2', forward: 'B1' },
        'A2': { left: 'A1', right: 'A3', forward: 'D2' },
        'A3': { left: 'A2', right: 'A4' },
		'A4': { left: 'A3', right: 'A1', back: 'D4' },
		'B1': { left: 'B4', right: 'B2', back: 'A1' },
        'B2': { left: 'B1', right: 'B3', forward: 'C2' },
        'B3': { left: 'B2', right: 'B4', forward: 'A3' },
		'B4': { left: 'B3', right: 'B1' },
		'C1': { left: 'C4', right: 'C2', back: 'D1' },
        'C2': { left: 'C1', right: 'C3', back: 'B2' },
        'C3': { left: 'C2', right: 'C4', forward: 'D3' },
		'C4': { left: 'C3', right: 'C1', forward: 'B4' },
		'D1': { left: 'D4', right: 'D2', forward: 'C1', back: 'F1' },
        'D2': { left: 'D1', right: 'D3', forward: 'UK2d' },
        'D3': { left: 'D2', right: 'D4', forward: 'F3', back: 'C3' },
		'D4': { left: 'D3', right: 'D1', forward: 'A4' },
		'F1': { left: 'F4', right: 'F2', forward: 'D1' },
        'F2': { left: 'F1', right: 'F3', back: 'G2' },
        'F3': { left: 'F2', right: 'F4', forward: 'I3', back: 'D3' }, //forward: 'I3'
		...
		'G3a': { back: 'G3', forward: { fn: () => { goTo('G1'); setMirror(!s.mirror); }}},
		'H1': { left: 'H4', right: 'H2' },
        ...
        'K3': { left: 'K2', right: 'K4' },
		'K4': { left: 'K3', right: 'psst' },
		'L1': { left: 'L4', right: 'L2' },
        'L2': { left: 'L1', right: 'L3', forward: 'I2' },
        'L3': { left: 'L2', right: 'L4', forward: 'K3' },
		'L4': { left: 'L3', right: 'L1' },
		'psst': { onEnter: () => { goTo('K1', 'right')}},

		'UK1a': { left: 'UK1d', right: 'UK1b' },
		'UK1b': { left: 'UK1a', right: 'UK1c' },
		'UK1c': { left: 'UK1b', right: 'UK1d', forward: 'UK2c' },
		'UK1d': { left: 'UK1c', right: 'UK1a' },

		'UK2a': { left: 'UK2d', right: 'UK2b', forward: 'UK1a'},
		'UK2b': { left: 'UK2a', right: 'UK2c' },
		'UK2c': { left: 'UK2b', right: 'UK2d' },
		'UK2d': { left: 'UK2c', right: 'UK2a', forward: 'D2' },
    }
}

function setMirror(isMirror) {
	if (s.mirror == isMirror) return
	s.mirror = isMirror
	let fadeIn = get('fadeIn')
	console.log(fadeIn)
	if (fadeIn != null) {
		fadeIn.style.transform = isMirror ? 'scaleX(-1)' : 'scaleX(1)';
		fadeIn.style.accentColor = 'red'
	}
	FRAME_IMG.style.transform = isMirror ? 'scaleX(-1)' :  'scaleX(1)';
